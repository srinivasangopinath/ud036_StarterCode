...
##There are four instance variables initialized namely Title, Storyline, Poster and Trailer that are related to the movie Toy Story
...
##There are four instance variables initialized namely Title, Storyline, Poster and Trailer that are related to the movie Avatar
...
##There are four instance variables initialized namely Title, Storyline, Poster and Trailer that are related to the movie Spongebob
spongebob= media.Movie("The SpongeBob SquarePants",
                        "American live-action animated comedy film inspired by the Nickelodeon television series SpongeBob SquarePants",
...
##There are four instance variables initialized namely Title, Storyline, Poster and Trailer that are related to the movie Home Alone 3
homealone3= media.Movie("Home Alone 3",
...
##There are four instance variables initialized namely Title, Storyline, Poster and Trailer that are related to the movie Harry Potter
harrypotter= media.Movie("Harry Potter and the Deathly Hallows part 2",
                        "Harry Potter and the Deathly Hallows – Part 2 is a 2011 British-American[5] fantasy film directed by David Yates and distributed by Warner Bros. Pictures",
...
##There are four instance variables initialized namely Title, Storyline, Poster and Trailer that are related to the movie Gandhi
